...
def test_match_api(text, expected_device_type):
    """测试匹配API"""
    try:
        ...
        if response.status_code == 200:
            ...
            if result.get('success') and result.get('matched_rows'):
...
for i, test_case in enumerate(test_cases, 1):
    ...
    success = test_match_api(test_case['text'], test_case['expected_device_type'])
