...
class TestEndToEndIntegration:
    ...
    def test_complete_workflow_xlsx(self, client, temp_dir):
        ...
        print(f"✓ 完整流程测试通过 (xlsx格式)")
    
    def test_complete_workflow_xls(self, client, temp_dir):
        """测试完整流程：xls格式"""
        # 1. 创建测试文件
    ...
    def test_merged_cells_preservation(self, client, temp_dir):
        """测试合并单元格保留"""
        # 创建带合并单元格的文件
    ...
    def test_special_characters(self, client, temp_dir):
        """测试特殊字符处理"""
    ...
    def test_large_file(self, client, temp_dir):
        """测试大文件处理"""
    ...
    def test_invalid_file_format(self, client, temp_dir):
        """测试无效文件格式"""
        # 创建一个文本文件
        ...
        print(f"✓ 无效文件格式拒绝测试通过")
    
    def test_missing_file_id(self, client):
        """测试缺少file_id参数"""
        response = client.post('/api/parse', 
                              json={},
                              content_type='application/json')
    ...
    def test_get_devices_api(self, client):
        ...
        assert 'unit_price' in device
        assert 'display_text' in device
        
        print(f"✓ 获取设备列表API测试通过")
    ...
    def test_data_integrity_in_export(self, client, temp_dir):
        """测试导出文件的数据完整性"""
        # 创建测试文件
